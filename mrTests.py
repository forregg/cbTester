...
def getMaxMinBars(window = 8, years = 0, summerTime = 777):
    ...
    for i in range(window, len(data) - window):
        ...
        if np.argmin(data[i-window:i, 3]) == window-1:
            res[get15minBarNum(data[i,0])] +=1
    return res

def plotMaxMinBars():
    window = 4
    mmSummer = getMaxMinBars(years=[2008,2009,2010,2011,2012,2013], summerTime = True, window=window)
    mmWinter = getMaxMinBars(years=[2008,2009,2010,2011,2012,2013], summerTime = False, window=window)
